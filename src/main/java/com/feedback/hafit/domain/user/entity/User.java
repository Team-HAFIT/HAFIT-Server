...
public class User extends BaseEntity {
    ...
    @Builder
    public User(String email, String password, String carrier, String phone, String sex, String name, String nickname, String imageUrl, int weight, int height,
                      String user_img, Character easy_login, String token, Character payment, LocalDate birthday, UserStatus user_status, SocialType socialType, String socialId, Role role) {
        this.email = email;
